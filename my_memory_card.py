...
questions_list.append(Question('Koja je najpolularnija igrica trenutno?', 'Fortnite', 'EA FC 24', 'Roblox', 'Minecraft'))
questions_list.append(Question('Koji je najbolji klub u Europi?', 'Real Madrid', 'Barcelona', 'Juventus', 'Liverpool'))
questions_list.append(Question('Koje je najbrze Auto u svijetu?', 'Konningseg Jesko Absolute', 'Bugati Chihron', 'Lamborghini Rvouelto', 'Meclaren P1'))
questions_list.append(Question('Koji je najpopularniji Sport u svijetu?', 'Futbal', 'Kosarka', 'Tenis', 'Plivanje'))
questions_list.append(Question('Koji je najpopularniji Telefonski brend u svijetu?', 'Apple', 'Samsung', 'Xaomi', 'Huwai'))
